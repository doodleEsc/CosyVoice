...
def main():
    ...
    if args.mode == "sft":
        payload = {"tts_text": args.tts_text, "spk_id": args.spk_id}
        response = requests.request("GET", url, data=payload, stream=True)
    elif args.mode == "zero_shot":
        payload = {"tts_text": args.tts_text, "prompt_text": args.prompt_text}
        files = [
            (
                "prompt_wav",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--prompt_wav", type=str, default="../../../zero_shot_prompt.wav"
    )
    parser.add_argument(
        "--instruct_text",
        type=str,
